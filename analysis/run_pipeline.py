...
Pipeline:
    ...
    └──────────────────┬───────────────────────────────────────────────────┘
                       │  establishes cross-task rank agreement
                       ▼
    ┌──────────────────────────────────────────────────────────────────────┐
    │  STEP 5  Human Participant Clustering  (Paper §4)                   │
    │  Script: 5_human_clustering/human_risk_clustering.py                │
    │  Logic:  per-subject features → K-means(3) → Cautious/Neutral/Agg  │
    │  Input:  data/human_data/human_features.csv  (full: HuggingFace)   │
    │  Output: figures/human_clustering/  +  Human_Clustered_Data.csv    │
    └──────────────────────────────────────────────────────────────────────┘
...
SCRIPTS = [
    ...
    ROOT / 'analysis' / '5_human_clustering' / 'human_risk_clustering.py',
]
...
STEP_LABELS = [
    ...
    'Step 5 — Human Participant Clustering',
]
